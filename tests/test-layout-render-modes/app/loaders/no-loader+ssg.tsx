  ...
  return (
    <div id="no-loader-page">
      ...
      <p id="no-loader-layout-data">
        Layout Data: {layoutMatch?.loaderData ? JSON.stringify(layoutMatch.loaderData) : 'none'}
      </p>
      <p id="no-loader-has-layout">Has Layout Loader: {layoutMatch?.loaderData ? 'yes' : 'no'}</p>
    </div>
  )
}
