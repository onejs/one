...
declare module 'one' {
  export namespace OneRouter {
    export interface __routes<T extends string = string> extends Record<string, unknown> {
      ...
      IsTyped: true
      RouteTypes: {
        '/dynamic-folder-routes/[serverId]/[channelId]': RouteInfo<{
          serverId: string
          channelId: string
        }>
        '/hooks/contents/with-nested-slug/[folderSlug]': RouteInfo<{ folderSlug: string }>
        '/hooks/contents/with-nested-slug/[folderSlug]/[fileSlug]': RouteInfo<{
          folderSlug: string
          fileSlug: string
        }>
        '/hooks/contents/with-slug/[slug]': RouteInfo<{ slug: string }>
        '/layouts/nested-layout/with-slug-layout-folder/[layoutSlug]': RouteInfo<{
          layoutSlug: string
        }>
