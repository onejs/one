// Index SSG page inside a route group - this is the EXACT pattern from takeout3 that caused flicker
// The homepage (/) is served from inside a route group layout
export default function IndexSSGPage() {
  return (
    <div id="index-ssg-root" data-testid="index-ssg-content">
      <h1>Homepage SSG Test</h1>
      <p id="index-ssg-marker">
        This is the index page served from inside a (hydration-delay) route group. This
        exact pattern caused visible hydration flicker in takeout3.
      </p>
      <div id="index-ssg-payload">
