...
declare global {
   ...
   * ```
   */
  export function $resolve<T extends Record<string, any>>(val: T): util.Output<util.Unwrap<T>>
  ...
  export function $resolve<T1, T2, T3, T4, T5>(
    values: [util.Input<T1>, util.Input<T2>, util.Input<T3>, util.Input<T4>, util.Input<T5>]
  ): util.Output<
    [util.Unwrap<T1>, util.Unwrap<T2>, util.Unwrap<T3>, util.Unwrap<T4>, util.Unwrap<T5>]
  >
