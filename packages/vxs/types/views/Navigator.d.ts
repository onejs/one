...
export declare function useNavigatorContext(): {
    ...
    navigation: {
        ...
        getParent<T = import("@react-navigation/native").NavigationHelpers<import("@react-navigation/routers").ParamListBase, {}> | undefined>(id?: string | undefined): T;
        getState(): Readonly<{
            key: string;
            index: number;
            routeNames: string[];
    ...
    } & import("@react-navigation/native").PrivateValueStore<[import("@react-navigation/routers").ParamListBase, unknown, unknown]> & import("@react-navigation/native").EventEmitter<Record<string, any>> & {
    ...
    descriptors: Record<string, import("@react-navigation/native").Descriptor<{}, Omit<{
        ...
        canGoBack(): boolean;
        getId(): string | undefined;
        getParent<T_1 = import("@react-navigation/native").NavigationHelpers<import("@react-navigation/routers").ParamListBase, {}> | undefined>(id?: string | undefined): T_1;
        getState(): Readonly<{
            key: string;
            index: number;
            routeNames: string[];
    ...
    } & import("@react-navigation/native").PrivateValueStore<[import("@react-navigation/routers").ParamListBase, unknown, unknown]>, "getParent"> & {
        getParent<T_1_1 = import("@react-navigation/native").NavigationProp<import("@react-navigation/routers").ParamListBase, string, undefined, Readonly<{
            key: string;
            index: number;
            routeNames: string[];
            history?: unknown[] | undefined;
        ...
        type: string;
        stale: false;
    }>>> & import("@react-navigation/native").PrivateValueStore<[import("@react-navigation/routers").ParamListBase, string, Record<string, any>]> & Record<string, () => void>, import("@react-navigation/native").RouteProp<import("@react-navigation/routers").ParamListBase, string>>>;
    router: RouterFactory<any, any, any>;
};
