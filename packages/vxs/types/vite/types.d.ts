...
export type VXSPluginOptions = {
    ...
    afterServerStart?: ((options: VXSOptions, server: Hono) => void | Promise<void>) | ((options: VXSOptions, server: Hono, buildInfo: AfterServerStartBuildInfo) => void | Promise<void>);
};
