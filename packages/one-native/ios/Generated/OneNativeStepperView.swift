...
@objcMembers public final class OneNativeStepperView: UIView {
  public var onChange: ((Double, Int, Int) -> Void)?
  private var model = StepperModel()
  private var controller: OneNativeHostingController<StepperContent>?
  ...
  private func updateHost() {
    ...
    if controller == nil {
      ...
      controller = OneNativeHostingController(rootView: StepperContent(model: model))
    }
