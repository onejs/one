...
export declare function Image({ systemName, symbolRenderingMode, symbolVariant, imageScale, variableValue, style, ...props }: Types.ImageProps): import("react/jsx-runtime").JSX.Element;
