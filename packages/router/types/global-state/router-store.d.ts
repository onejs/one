...
import { type UrlObject } from '../../src/LocationProvider'
import type { RouteNode } from '../../src/Route'
import type { ResultState } from '../../src/fork/getStateFromPath'
import { type ExpoLinkingOptions } from '../../src/getLinkingConfig'
import type { RequireContext } from '../../src/types'
/**
...
export declare class RouterStore {
  ...
  goBack: () => void
  canGoBack: () => boolean
  push: (url: import('../../src/interfaces/router').ExpoRouter.Href) => void
  dismiss: (count?: number | undefined) => void
  replace: (url: import('../../src/interfaces/router').ExpoRouter.Href) => void
  dismissAll: () => void
  canDismiss: () => boolean
  setParams: (params?: Record<string, string | number> | undefined) => any
  navigate: (url: import('../../src/interfaces/router').ExpoRouter.Href) => void
  initialize(
