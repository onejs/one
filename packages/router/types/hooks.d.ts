import type { ExpoRouter } from '../src/interfaces/expo-router'
type SearchParams = Record<string, string | string[]>
export declare function useRootNavigationState(): import('../src/fork/getStateFromPath').ResultState
export declare function useRouteInfo(): import('../src/LocationProvider').UrlObject
/** @deprecated use `useNavigationContainerRef()` instead, which returns a React ref. */
export declare function useRootNavigation():
  | import('@react-navigation/core').NavigationContainerRef<ReactNavigation.RootParamList>
  | null
