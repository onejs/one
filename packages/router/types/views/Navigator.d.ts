...
export declare function Navigator({
  initialRouteName,
  screenOptions,
  children,
  router,
}: NavigatorProps): import('react/jsx-runtime').JSX.Element | null
export declare namespace Navigator {
  var Slot: typeof import('../../src/views/Navigator').Slot
  var useContext: typeof useNavigatorContext
  var Screen: typeof import('../../src/views/Screen').Screen
}
export declare function useNavigatorContext(): {
  ...
  state: Readonly<{
    ...
    routes: (Readonly<{
      ...
      Readonly<{
        ...
        state?:
          | Readonly<any>
          | import('@react-navigation/routers').PartialState<Readonly<any>>
          | undefined
      })[]
    type: string
    stale: false
  ...
  navigation: {
    ...
    getParent<
      T =
        | import('@react-navigation/core').NavigationHelpers<
  ...
  } & import('@react-navigation/core').PrivateValueStore<
    [import('@react-navigation/routers').ParamListBase, unknown, unknown]
  > &
    import('@react-navigation/core').EventEmitter<Record<string, any>> & {
  ...
  descriptors: Record<
    ...
    import('@react-navigation/core').Descriptor<
      ...
      Omit<
        {
          ...
          navigate<RouteName_3 extends string>(
            ...args: RouteName_3 extends unknown
              ? [screen: RouteName_3] | [screen: RouteName_3, params: object | undefined]
              : never
          ): void
          navigate<RouteName_1_1 extends string>(
            options: RouteName_1_1 extends unknown
              ?
                  | {
                      key: string
                      params?: object | undefined
      ...
      > & {
        getParent<
          T_1_1 =
            | import('@react-navigation/core').NavigationProp<
              ...
              >
            | undefined,
        >(id?: string | undefined): T_1_1
        setParams(params: Partial<object | undefined>): void
        setOptions(options: Partial<{}>): void
      } & import('@react-navigation/core').EventConsumer<
          Record<string, any> &
        ...
        > &
        import('@react-navigation/core').PrivateValueStore<
          [import('@react-navigation/routers').ParamListBase, string, Record<string, any>]
        > &
        Record<string, () => void>,
...
export declare function Slot(
  props: Omit<NavigatorProps, 'children'>
