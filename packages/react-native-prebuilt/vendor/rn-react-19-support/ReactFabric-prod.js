...
for (pluginName$jscomp$inline_283 in injectedNamesToPlugins$jscomp$inline_281)
  if (injectedNamesToPlugins$jscomp$inline_281.hasOwnProperty(pluginName$jscomp$inline_283)) {
        ...
        void 0 !== prevProp &&
          ...
          "function" === typeof attributeConfig.process
            ? (((updatePayload || (updatePayload = {}))[propKey$5] = null),
              ...
              removedKeys[propKey$5] || ((removedKeys[propKey$5] = !0), removedKeyCount++))
...
function resolveClassComponentProps(Component, baseProps) {
  ...
  if ((Component = Component.defaultProps)) {
    ...
    for (var propName$51 in Component)
      void 0 === newProps[propName$51] && (newProps[propName$51] = Component[propName$51]);
  }
  return newProps;
}
    ...
    if (showFallback)
      return (
        ...
        0 === (showFallback & 1) && null !== didSuspend
          ? ((didSuspend.childLanes = 0), (didSuspend.pendingProps = nextPrimaryChildren))
        ...
        if (!newProps)
          if (((current = findFirstSuspended(updatePayload)), null !== current)) {
            if (
              ...
              null === oldProps.tail && "hidden" === oldProps.tailMode && !updatePayload.alternate)
            )
              return (bubbleProperties(workInProgress), null);
          } else
            2 * now() - oldProps.renderingStartTime > workInProgressRootRenderTargetTime &&
...
if ("undefined" !== typeof __REACT_DEVTOOLS_GLOBAL_HOOK__) {
  ...
  if (!hook$jscomp$inline_1463.isDisabled && hook$jscomp$inline_1463.supportsFiber)
    try {
      ((rendererID = hook$jscomp$inline_1463.inject(internals$jscomp$inline_1147)),
