...
for (pluginName$jscomp$inline_290 in injectedNamesToPlugins$jscomp$inline_288)
  if (injectedNamesToPlugins$jscomp$inline_288.hasOwnProperty(pluginName$jscomp$inline_290)) {
...
function resolveClassComponentProps(Component, baseProps) {
  ...
  if ((Component = Component.defaultProps)) {
    ...
    for (var propName$53 in Component)
      void 0 === newProps[propName$53] && (newProps[propName$53] = Component[propName$53]);
  }
  return newProps;
}
...
if ("undefined" !== typeof __REACT_DEVTOOLS_GLOBAL_HOOK__) {
  ...
  if (!hook$jscomp$inline_1551.isDisabled && hook$jscomp$inline_1551.supportsFiber)
    try {
      ((rendererID = hook$jscomp$inline_1551.inject(internals$jscomp$inline_1213)),
