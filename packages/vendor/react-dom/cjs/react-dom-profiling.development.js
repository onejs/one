  ...
  (function () {
    ...
    function copyWithDeleteImpl(obj, path, index) {
      ...
      if (index + 1 === path.length)
        return (
          isArrayImpl(updated) ? updated.splice(key, 1) : delete updated[key], updated
        )
    ...
    function checkIfRootIsPrerendering(root, renderLanes) {
      return (
        0 ===
        (root.pendingLanes & ~(root.suspendedLanes & ~root.pingedLanes) & renderLanes)
      )
    }
    function computeExpirationTime(lane, currentTime) {
      switch (lane) {
        ...
        default:
          return (
            console.error('Should have found matching lanes. This is a bug in React.'), -1
          )
      }
    }
    ...
    function batchedUpdates$2(fn, a, b) {
      ...
      try {
        ...
        if (
          ((isInsideEventHandler = !1), null !== restoreTarget || null !== restoreQueue)
        )
          if (
            (flushSyncWork$1(),
            restoreTarget &&
        ...
        if ('object' === typeof newChild && null !== newChild) {
          switch (newChild.$$typeof) {
            case REACT_ELEMENT_TYPE:
              return (
                (newIdx =
                  existingChildren.get(null === newChild.key ? newIdx : newChild.key) ||
                  null),
    ...
    function useThenable(thenable) {
      ...
      null ===
        (null === workInProgressHook ? index.memoizedState : workInProgressHook.next) &&
    ...
    function updateOffscreenComponent(current, workInProgress, renderLanes) {
      var nextProps = workInProgress.pendingProps,
        ...
        nextIsDetached =
          0 !== (workInProgress.stateNode._pendingVisibility & OffscreenDetached),
    ...
    function updateSuspenseListComponent(current, workInProgress, renderLanes) {
      ...
      if (
        ...
        if (
          ((didWarnAboutRevealOrder[revealOrder] = !0), 'string' === typeof revealOrder)
        )
        ...
        case 16:
          a: if (
            ...
            if (void 0 !== current && null !== current)
              if (
                ((prevSibling = current.$$typeof), prevSibling === REACT_FORWARD_REF_TYPE)
              ) {
            ...
            null === current
              ? (current = getResource(
                ...
                : isHydrating ||
                  ...
                  (returnFiber =
                    getOwnerDocumentFromRootContainer(returnFiber).createElement(
                      current
                    )),
        ...
        case 6:
          return (
            null === current &&
              ...
              (current =
                null != renderLanes ? validateTextNesting(current, renderLanes.tag) : !0),
    ...
    function preloadResourceAndSuspendIfNeeded(workInProgress, resource) {
      if (
        ...
        if (
          ...
          throw (
            (suspendedThenable = noopSuspenseyCommitThenable), SuspenseyCommitException
          )
    ...
    function propNamesListJoin(list, combinator) {
      switch (list.length) {
        ...
        default:
          return (
            list.slice(0, -1).join(', ') + ', ' + combinator + ' ' + list[list.length - 1]
          )
      }
    }
      ...
      if (null === resource.instance)
        switch (resource.type) {
          ...
          case 'stylesheet':
            ...
            _instance = (hoistableRoot.ownerDocument || hoistableRoot).createElement(
              'link'
            )
            markNodeAsHoistable(_instance)
      ...
      S: function (href, precedence, options) {
        ...
        if (ownerDocument && href) {
          ...
          if (!resource) {
            ...
            if (
              (resource = ownerDocument.querySelector(getStylesheetSelectorFromKey(key)))
            )
