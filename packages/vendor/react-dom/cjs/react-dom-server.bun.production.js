...
function createRenderState(
  ...
  var inlineScriptWithNonce =
      void 0 === nonce ? "<script>" : '<script nonce="' + escapeTextForBrowser(nonce) + '">',
  ...
  if (void 0 !== bootstrapScripts)
    for (onHeaders = 0; onHeaders < bootstrapScripts.length; onHeaders++) {
      ...
      externalRuntimeConfig.push('<script src="', escapeTextForBrowser(maxHeadersLength));
      nonce && externalRuntimeConfig.push('" nonce="', escapeTextForBrowser(nonce));
      "string" === typeof idPrefix &&
        externalRuntimeConfig.push('" integrity="', escapeTextForBrowser(idPrefix));
      "string" === typeof inlineScriptWithNonce &&
        externalRuntimeConfig.push('" crossorigin="', escapeTextForBrowser(inlineScriptWithNonce));
  ...
  if (void 0 !== bootstrapModules)
    for (bootstrapScripts = 0; bootstrapScripts < bootstrapModules.length; bootstrapScripts++)
      ((bootstrapScriptContent = bootstrapModules[bootstrapScripts]),
        ...
        externalRuntimeConfig.push('<script type="module" src="', escapeTextForBrowser(onHeaders)),
        nonce && externalRuntimeConfig.push('" nonce="', escapeTextForBrowser(nonce)),
        "string" === typeof inlineScriptWithNonce &&
          externalRuntimeConfig.push('" integrity="', escapeTextForBrowser(inlineScriptWithNonce)),
        "string" === typeof maxHeadersLength &&
          externalRuntimeConfig.push('" crossorigin="', escapeTextForBrowser(maxHeadersLength)),
        externalRuntimeConfig.push('" async="">\x3c/script>'));
  return importMap;
}
...
function writeStartSegment(destination, renderState, formatContext, id) {
  switch (formatContext.insertionMode) {
    ...
    case 3:
      return (
        writeChunk(destination, '<svg aria-hidden="true" style="display:none" id="'),
        writeChunk(destination, renderState.segmentPrefix),
        writeChunk(destination, id.toString(16)),
        !!destination.write('">')
      );
    case 4:
      return (
        writeChunk(destination, '<math aria-hidden="true" style="display:none" id="'),
        writeChunk(destination, renderState.segmentPrefix),
        writeChunk(destination, id.toString(16)),
        !!destination.write('">')
      );
        ...
        case "image":
          ...
          0 <= (resumableState.remainingCapacity -= header.length + 2))
            ...
            : ((resumableState = []),
              pushLinkImpl(
                resumableState,
                assign({ rel: "preload", href: imageSrcSet ? void 0 : href, as: as }, options),
              ),
              "high" === fetchPriority
  ...
  if (request) {
    ...
    if (href) {
      ...
      null !== resourceState &&
        ...
        (precedence = {
          state: 0,
          props: assign({ rel: "stylesheet", href: href, "data-precedence": precedence }, options),
        }),
        resourceState &&
    ...
    if (null !== request && "function" === typeof isSignatureEqual) {
      ...
      isSignatureEqual.call(action, request[2], request[3]) &&
        ((nextPostbackStateKey =
          void 0 !== permalink
            ? "p" + permalink
            : "k" + Bun.hash(JSON.stringify([componentKeyPath, null, actionStateHookIndex]))),
...
var HooksDispatcher = {
  ...
  useId: function () {
    ...
    JSCompiler_inline_result =
      (JSCompiler_inline_result & ~(1 << (32 - clz32(JSCompiler_inline_result) - 1))).toString(32) +
      overflow;
          ...
          if (
            ...
            for (ref = ref ? 1 : 0; ref < type.length; ref++)
              ((propName$33 = type[ref]),
                ...
                null != propName$33 &&
                  (initialState
                    ? ((initialState = !1), (defaultProps = assign({}, defaultProps, propName$33)))
            ...
            try {
              ...
              ((propName.status = 4),
                12 === request.status
                  ...
                  : ((contentRootSegment.status = 4), (newProps = thrownValue$28)),
  ...
  if (null === segment)
    ...
    try {
      ...
      if (
        ...
        (node = thrownValue$48 === SuspenseException ? getSuspendedThenable() : thrownValue$48),
        "object" === typeof node && null !== node)
      ) {
        if ("function" === typeof node.then) {
          childIndex = getThenableStateAfterSuspending();
  ...
  if (null === boundary) {
    if (13 !== request.status && 14 !== request.status) {
      ...
      0 === boundary.pendingTasks &&
        ...
        abortRemainingReplayNodes(request, null, boundary.nodes, boundary.slots, error, task));
    ...
    try {
      ...
      for (i = 0; i < pingedTasks.length; i++) {
        ...
        if (null === segment) {
          ...
          if (0 !== task.replay.pendingTasks) {
            ...
            try {
              "number" === typeof task.replay.slots
                ? resumeNode(request$jscomp$0, task, task.replay.slots, task.node, task.childIndex)
              ...
              if ("object" === typeof x && null !== x && "function" === typeof x.then) {
                ...
                var request$jscomp$1 = request$jscomp$0,
                  ...
                  error$jscomp$0 = 12 === request$jscomp$0.status ? request$jscomp$0.fatalError : x,
          ...
          ((request$jscomp$0 = void 0), (request$jscomp$1 = segment), 0 === request$jscomp$1.status)
        ) {
  ...
  if (4 === boundary.status)
    ...
    (0 === boundary.status && (boundary.rootSegmentID = request.nextSegmentId++),
      ...
      hoistableState &&
        ...
        boundary.stylesheets.forEach(hoistStylesheetDependency, hoistableState)),
      flushSubtree(request, destination, segment, hoistableState));
...
function flushCompletedBoundary(request, destination, boundary) {
  ...
  writeChunk(destination, completedSegments);
  requiresStyleInsertion
    ? (writeChunk(destination, '",'), writeStyleResourceDependenciesInJS(destination, boundary))
    : writeChunk(destination, '"');
  ...
  try {
    if (!(0 < request.pendingRootTasks)) {
      ...
      for (i = 0; i < clientRenderedBoundaries.length; i++) {
        ...
        var JSCompiler_inline_result = !!renderState$jscomp$0.write(")\x3c/script>");
...
if ("19.0.0" !== isomorphicReactPackageVersion$jscomp$inline_731)
  throw Error(
