...
if (canUseDOM) {
  ...
  if (canUseDOM) {
    ...
    if (!isSupported$jscomp$inline_435) {
      ...
      isSupported$jscomp$inline_435 = "function" === typeof element$jscomp$inline_436.oninput;
    }
    JSCompiler_inline_result$jscomp$299 = isSupported$jscomp$inline_435;
  } else JSCompiler_inline_result$jscomp$299 = !1;
  isInputEventSupported =
    JSCompiler_inline_result$jscomp$299 && (!document.documentMode || 9 < document.documentMode);
}
  ...
  if (
    ...
    if (null !== priorSelectionRange && hasSelectionCapabilities(containerInfo))
      if (
        ...
        priorSelectionRange =
          void 0 === priorSelectionRange.end ? start : Math.min(priorSelectionRange.end, length);
...
function getRootForUpdatedFiber(sourceFiber) {
  if (50 < nestedUpdateCount)
    throw (
      (nestedUpdateCount = 0), (rootWithNestedUpdates = null), Error(formatProdErrorMessage(185))
    );
      ...
      for (shouldClear = 0; fiber; ) {
        if (8 === fiber.nodeType)
          if (((JSCompiler_temp = fiber.data), "/$" === JSCompiler_temp)) {
            ...
            ("$" !== JSCompiler_temp && "$!" !== JSCompiler_temp && "$?" !== JSCompiler_temp) ||
              shouldClear++;
        fiber = fiber.nextSibling;
      }
      nextHydratableInstance = null;
...
function findFirstSuspended(row) {
  for (var node = row; null !== node; ) {
    if (13 === node.tag) {
      ...
      if (
        null !== state &&
        ((state = state.dehydrated), null === state || "$?" === state.data || "$!" === state.data)
      )
        return node;
      ...
      if (
        ...
        if (0 === revertLane)
          (null !== newBaseQueueLast &&
            ...
            updateLane === currentEntangledLane && (didReadFromEntangledAsyncAction$56 = !0));
        else if ((renderLanes & revertLane) === revertLane) {
          update = update.next;
          revertLane === currentEntangledLane && (didReadFromEntangledAsyncAction$56 = !0);
          continue;
        } else
          ((updateLane = {
            lane: 0,
...
function resolveClassComponentProps(Component, baseProps) {
  ...
  if ((Component = Component.defaultProps)) {
    ...
    for (var propName$69 in Component)
      void 0 === newProps[propName$69] && (newProps[propName$69] = Component[propName$69]);
  }
  return newProps;
}
      ...
      workInProgress.flags & 256
        ...
        : null !== workInProgress.memoizedState
          ...
          : (reuseSuspenseHandlerOnStack(workInProgress),
            ...
            (showFallback = createFiberFromFragment(showFallback, nextInstance, renderLanes, null)),
          ...
          if (
            ...
            for (
              nextHydratableInstance = getNextHydratable(
                ...
                hydrationErrors = null,
                rootOrSingletonContext = !0,
                renderLanes = mountChildFibers(workInProgress, null, nextProps, renderLanes),
                workInProgress.child = renderLanes;
              renderLanes;
            )
...
function isHostParent(fiber) {
  return (
    5 === fiber.tag || 3 === fiber.tag || 26 === fiber.tag || 27 === fiber.tag || 4 === fiber.tag
  );
}
        ...
        (hostParentIsContainer
          ? ((nearestMountedAncestor = hostParent),
            ...
            8 === nearestMountedAncestor.nodeType
              ? clearSuspenseBoundary(nearestMountedAncestor.parentNode, deletedFiber)
...
function commitMutationEffectsOnFiber(finishedWork, root) {
  ...
  switch (finishedWork.tag) {
                ...
                b: switch (flags) {
                  case "title":
                    ...
                    if (
                      ...
                      "http://www.w3.org/2000/svg" === hoistableRoot.namespaceURI ||
    ...
    case 22:
      ...
      if (
        flags & 8192 &&
        ((root._visibility = node ? root._visibility & -2 : root._visibility | 1),
        node &&
        ...
        switch (JSCompiler_inline_result.tag) {
          ...
          case 5:
            ...
            JSCompiler_inline_result.flags & 32 &&
              (setTextContent(parent$119, ""), (JSCompiler_inline_result.flags &= -33));
          ...
          case 4:
            ...
            insertOrAppendPlacementNodeIntoContainer(finishedWork, before$122, parent$121);
            break;
          default:
  ...
  for (parentFiber = parentFiber.child; null !== parentFiber; ) {
    ...
    switch (deletions.tag) {
      ...
      case 22:
        ...
        i._visibility & 4 &&
          ((i._visibility &= -5), recursivelyTraverseDisconnectPassiveEffects(deletions));
        break;
      default:
        recursivelyTraverseDisconnectPassiveEffects(deletions);
    }
  ...
  var primaryChildInstance = {
    ...
    detach: function () {
      ...
      if (0 === (primaryChildInstance._pendingVisibility & 2)) {
        var root = enqueueConcurrentRenderForLane(fiber, 2);
        null !== root &&
          ((primaryChildInstance._pendingVisibility |= 2), scheduleUpdateOnFiber(root, fiber, 2));
      }
    },
    attach: function () {
      var fiber = primaryChildInstance._current;
      ...
      if (0 !== (primaryChildInstance._pendingVisibility & 2)) {
        var root = enqueueConcurrentRenderForLane(fiber, 2);
        null !== root &&
          ((primaryChildInstance._pendingVisibility &= -3), scheduleUpdateOnFiber(root, fiber, 2));
      }
    },
  };
...
function bubbleProperties(completedWork) {
  ...
  if (didBailout)
    if (0 !== (completedWork.mode & 2)) {
      for (
        var treeBaseDuration$143 = completedWork.selfBaseDuration, child$144 = completedWork.child;
        null !== child$144;
      )
      ...
      for (treeBaseDuration$143 = completedWork.child; null !== treeBaseDuration$143; )
        ((newChildLanes |= treeBaseDuration$143.lanes | treeBaseDuration$143.childLanes),
        ...
        if (!newProps)
          if (((current = findFirstSuspended(cache$159)), null !== current)) {
            ...
            2 * now$1() - type.renderingStartTime > workInProgressRootRenderTargetTime &&
              ...
              (workInProgress.lanes = 4194304));
        type.isBackwards
          ? ((cache$159.sibling = workInProgress.child), (workInProgress.child = cache$159))
          : ((current = type.last),
            null !== current ? (current.sibling = cache$159) : (workInProgress.child = cache$159),
            (type.last = cache$159));
      }
      if (null !== type.tail)
        return (
...
function performWorkOnRoot(root$jscomp$0, lanes, forceSync) {
  ...
  var shouldTimeSlice =
      (!forceSync && 0 === (lanes & 60) && 0 === (lanes & root$jscomp$0.expiredLanes)) ||
  ...
  do {
    if (0 === exitStatus) {
      ...
      markRootSuspended(root$jscomp$0, lanes, 0, !workInProgressRootDidSkipSuspendedSiblings);
    else {
        ...
        if (props.hasOwnProperty(hasSrc)) {
          ...
          if (null != propValue$201)
            switch (hasSrc) {
              ...
              case "children":
              case "dangerouslySetInnerHTML":
                if (null != propValue$201) throw Error(formatProdErrorMessage(137, tag));
                break;
              default:
      ...
      if (isCustomElement(tag)) {
        for (propValue$201 in props)
          props.hasOwnProperty(propValue$201) &&
            ...
            void 0 !== hasSrc &&
              setPropOnCustomElement(domElement, tag, propValue$201, hasSrc, props, void 0));
        return;
      }
  }
  ...
  switch (tag) {
    ...
    case "input":
      ...
      for (var propKey$218 in nextProps) {
        ...
        if (nextProps.hasOwnProperty(propKey$218) && (null != propKey || null != lastProp))
          switch (propKey$218) {
            case "type":
              type = propKey;
              break;
            ...
            default:
              propKey !== lastProp &&
                setProp(domElement, tag, propKey$218, propKey, nextProps, lastProp);
          }
      }
      updateInput(
        domElement,
        ...
        if (
          ...
          switch (propKey$234) {
            case "selected":
              ...
              break;
            default:
              setProp(domElement, tag, propKey$234, null, nextProps, propKey$218);
          }
      for (lastDefaultValue in nextProps)
        if (
          ...
          switch (lastDefaultValue) {
            case "selected":
              domElement.selected =
                propKey$218 && "function" !== typeof propKey$218 && "symbol" !== typeof propKey$218;
              break;
            default:
              setProp(domElement, tag, lastDefaultValue, propKey$218, nextProps, propKey);
          }
      return;
    case "img":
    case "link":
      ...
      for (checked in nextProps)
        if (
          ...
          switch (checked) {
            case "children":
            case "dangerouslySetInnerHTML":
              if (null != propKey$218) throw Error(formatProdErrorMessage(137, tag));
              break;
            default:
              setProp(domElement, tag, checked, propKey$218, nextProps, propKey);
          }
      return;
    default:
      if (isCustomElement(tag)) {
        for (var propKey$244 in lastProps)
          ((propKey$218 = lastProps[propKey$244]),
            lastProps.hasOwnProperty(propKey$244) &&
              ...
              setPropOnCustomElement(domElement, tag, propKey$244, void 0, nextProps, propKey$218));
  ...
  switch (type) {
    ...
    case "link":
      if (
        ...
        var styles$257 = getResourcesFromRoot(JSCompiler_inline_result).hoistableStyles,
        ...
        resource$258 ||
          ...
          (styles$257 = JSCompiler_inline_result.querySelector(
            ...
            !styles$257._p &&
            ((resource$258.instance = styles$257), (resource$258.state.loading = 5)),
          preloadPropsMap.has(type) ||
            ...
            styles$257 ||
              preloadStylesheet(JSCompiler_inline_result, type, pendingProps, resource$258.state)));
  ...
  if (null === resource.instance)
    switch (resource.type) {
      ...
      case "stylesheet":
        ...
        var instance$263 = hoistableRoot.querySelector(getStylesheetSelectorFromKey(styleProps));
        if (instance$263)
          return (
        ...
        instance$263 = (hoistableRoot.ownerDocument || hoistableRoot).createElement("link");
        markNodeAsHoistable(instance$263);
      ...
      case "script":
        ...
        if ((styleProps = hoistableRoot.querySelector(getScriptSelectorFromKey(instance$263))))
...
if ("19.0.0" !== isomorphicReactPackageVersion$jscomp$inline_1777)
  throw Error(
    formatProdErrorMessage(527, isomorphicReactPackageVersion$jscomp$inline_1777, "19.0.0"),
  );
...
var internals$jscomp$inline_1784 = {
  ...
  getLaneLabelMap: function () {
    for (var map = new Map(), lane = 1, index$280 = 0; 31 > index$280; index$280++) {
...
if ("undefined" !== typeof __REACT_DEVTOOLS_GLOBAL_HOOK__) {
  ...
  if (!hook$jscomp$inline_2221.isDisabled && hook$jscomp$inline_2221.supportsFiber)
    try {
      ((rendererID = hook$jscomp$inline_2221.inject(internals$jscomp$inline_1784)),
