...
export declare namespace Navigator {
    export { Slot };
    export { useNavigatorContext as useContext };
    export { Screen };
}
...
export declare const Slot: React.MemoExoticComponent<(props: Omit<NavigatorProps, 'children'>) => import("react/jsx-runtime").JSX.Element>;
