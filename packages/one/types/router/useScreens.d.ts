...
export declare const Screen: <RouteName extends string>(
 ...
 */
export declare function useSortedScreens(
  order: ScreenProps[],
  options?: {
...
export declare function getQualifiedRouteComponent(
  value: RouteNode
):
  | React.ComponentType<any>
  | React.NamedExoticComponent<Omit<any, 'ref'> & React.RefAttributes<unknown>>
/** @returns a function which provides a screen id that matches the dynamic route name in params. */
export declare function createGetIdForRoute(
