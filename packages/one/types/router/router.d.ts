 ...
 */
export declare function registerProtectedRoutes(
  contextKey: string,
...
export declare function subscribeToValidationState(
 ...
 */
export declare function handleNavigationContainerStateChange(
...
export declare function setParams(
  params?: OneRouter.InpurRouteParamsGeneric
): void | undefined
...
export declare function updateState(
  ...
  nextStateParam?: OneRouter.ResultState
): void
export declare function consumePendingNavigationAction():
  | 'REPLACE'
  | 'NAVIGATE'
  | 'PUSH'
  | undefined
export declare function subscribeToRootState(
  subscriber: OneRouter.RootStateListener
): () => void
export declare function subscribeToStore(subscriber: () => void): () => void
export declare function subscribeToLoadingState(
...
export declare function preloadRoute(
  href: string,
  injectCSS?: boolean
