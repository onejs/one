...
export type { StackHeaderProps, StackHeaderBackButtonProps, StackHeaderTitleProps, StackHeaderLeftProps, StackHeaderRightProps, StackHeaderSearchBarProps, StackScreenProps, StackScreenOptions, } from './layouts/stack-utils';
export type { StackRender, StackRenderProps, StackRenderComponent, } from './router/web/ScreenRenderContext';
export { setupRendering, getRenderingConfig, type RenderingConfig, type TabsRender, type TabsRenderProps, type TabsRenderComponent, type DrawerRender, type DrawerRenderProps, type DrawerRenderComponent, } from './router/renderingRegistry';
