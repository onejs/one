...
export declare let CACHE_KEY: string;
...
export declare let LOADER_JS_POSTFIX: string;
export declare let PRELOAD_JS_POSTFIX: string;
export declare let CSS_PRELOAD_JS_POSTFIX: string;
export declare const PRELOAD_JS_POSTFIX_REGEX: RegExp;
export declare const CSS_PRELOAD_JS_POSTFIX_REGEX: RegExp;
export declare function setCacheKey(key: string): void;
