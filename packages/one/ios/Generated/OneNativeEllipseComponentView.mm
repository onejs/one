...
@implementation OneNativeEllipseComponentView { OneNativeEllipseView *_nativeView; }
...
- (instancetype)initWithFrame:(CGRect)frame {
  if (self = [super initWithFrame:frame]) {
    ...
    _nativeView.onSDKEvent = ^(NSString *name, NSString *value) {
      ...
      auto emitter = std::static_pointer_cast<const OneNativeEllipseEventEmitter>(strongSelf->_eventEmitter);
