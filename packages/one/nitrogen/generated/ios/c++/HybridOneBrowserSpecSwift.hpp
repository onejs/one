...
namespace margelo::nitro::one {
  ...
  public:
    ...
    explicit HybridOneBrowserSpecSwift(const One::HybridOneBrowserSpec_cxx& swiftPart):
      HybridObject(HybridOneBrowserSpec::TAG),
      _swiftPart(swiftPart) { }

  public:
    // Get the Swift part
    inline One::HybridOneBrowserSpec_cxx& getSwiftPart() noexcept {
      return _swiftPart;
    }
  ...
  private:
    One::HybridOneBrowserSpec_cxx _swiftPart;
  };
