...
function Picker(_props: Types.PickerProps): never {
  throw new Error('Swift.Picker requires an iOS native build')
}
...
function Toggle(_props: Types.ToggleProps): never {
  throw new Error('Swift.Toggle requires an iOS native build')
}
function Slider(_props: Types.SliderProps): never {
  throw new Error('Swift.Slider requires an iOS native build')
}
...
function Label(_props: Types.LabelProps): never {
  throw new Error('Swift.Label requires an iOS native build')
}
function ProgressView(_props: Types.ProgressViewProps): never {
  throw new Error('Swift.ProgressView requires an iOS native build')
}
function Gauge(_props: Types.GaugeProps): never {
  throw new Error('Swift.Gauge requires an iOS native build')
}
function Image(_props: Types.ImageProps): never {
  throw new Error('Swift.Image requires an iOS native build')
}
function ShareLink(_props: Types.ShareLinkProps): never {
  throw new Error('Swift.ShareLink requires an iOS native build')
}
function ContentUnavailableView(_props: Types.ContentUnavailableViewProps): never {
  throw new Error('Swift.ContentUnavailableView requires an iOS native build')
}
function Circle(_props: Types.CircleProps): never {
  throw new Error('Swift.Circle requires an iOS native build')
}
function Capsule(_props: Types.CapsuleProps): never {
  throw new Error('Swift.Capsule requires an iOS native build')
}
function Rectangle(_props: Types.RectangleProps): never {
  throw new Error('Swift.Rectangle requires an iOS native build')
}
function RoundedRectangle(_props: Types.RoundedRectangleProps): never {
  throw new Error('Swift.RoundedRectangle requires an iOS native build')
}
...
function WebView(_props: Types.WebViewProps): never {
  throw new Error('Swift.WebView requires an iOS native build')
}
function SignInWithAppleButton(_props: Types.SignInWithAppleButtonProps): never {
  throw new Error('Swift.SignInWithAppleButton requires an iOS native build')
}
function Map(_props: Types.MapProps): never {
  throw new Error('Swift.Map requires an iOS native build')
}
function TextField(_props: Types.TextFieldProps): never {
  throw new Error('Swift.TextField requires an iOS native build')
}
...
function ConfirmationDialog(_props: Types.ConfirmationDialogProps): never {
  throw new Error('Swift.ConfirmationDialog requires an iOS native build')
}
function QuickLook(_props: Types.QuickLookProps): never {
  throw new Error('Swift.QuickLook requires an iOS native build')
}
function FileImporter(_props: Types.FileImporterProps): never {
  throw new Error('Swift.FileImporter requires an iOS native build')
}
function EditButton(_props: Types.EditButtonProps): never {
  throw new Error('Swift.EditButton requires an iOS native build')
}
function EmptyView(_props: Types.EmptyViewProps): never {
  throw new Error('Swift.EmptyView requires an iOS native build')
}
