...
// uniform map on android: google maps compose, driven by the same google-style
// zoom as ios. native reports a marker tap as an id; the marker object comes
// back from the props the app passed.
export function Map({
  cameraPosition,
  markers,
  polylines,
