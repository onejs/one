...
// composes React Native's Metro preset with One's canonical plugin chain.
`
    : `// ${ONE_GENERATED_MARKER}
//
// auto-generated by \`one metro-eject\`. composes React Native's Metro
// preset with One's router/setup transforms.
//
...
module.exports = {
  presets: [
    ...
    ['one/babel-preset', oneBundlerOptions],
  ],
}
`
}
...
`
    : `// ${ONE_GENERATED_MARKER}
//
// auto-generated by \`one metro-eject\`. delegates to one/metro-config,
// which invokes the same metro pipeline One uses for production native
// bundles with your router and setup options.
//
// to customize, delete this header and edit freely. re-runs will then
// leave this file alone.
`
