...
const BABEL_AUTO = `// ${ONE_GENERATED_MARKER}
//
...
const METRO_AUTO = `// ${ONE_GENERATED_MARKER}
//
// Auto-generated by \`one patch\` on CI/EAS workers when expo-updates is
...
const BABEL_EJECTED = `// You own this file. Edit freely — \`one\` will not regenerate it.
// Delegates to one/babel-preset which holds the canonical plugin chain.

module.exports = require('one/babel-preset')
`

const METRO_EJECTED = `// You own this file. Edit freely — \`one\` will not regenerate it.
...
const FILES: readonly FileSpec[] = [
  {
    ...
    autoContent: BABEL_AUTO,
    ejectedContent: BABEL_EJECTED,
    conflicting: ['babel.config.js', 'babel.config.mjs', '.babelrc', '.babelrc.js'],
  },
  {
    name: 'metro.config.cjs',
    autoContent: METRO_AUTO,
    ejectedContent: METRO_EJECTED,
...
export function generateBundlerConfig(args: GenerateBundlerConfigArgs = {}): {
  ...
  for (const file of FILES) {
    ...
    const targetContent = eject ? file.ejectedContent : file.autoContent
