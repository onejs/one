...
export function Sitemap() {
  ...
  //   const routes = useOneRouter().getSortedRoutes()
  ...
  //                 <View style={{ flexDirection: 'row', alignItems: 'center' }}>
  //                   {!!info && (
  //                     <Text style={[styles.virtual, !disabled && { marginRight: 8 }]}>
  //                       {info}
  //                     </Text>
  //                   )}
...
// function FileIcon() {
//   return <Image style={styles.image} source={require('router/assets/file.png')} />
// }

// function PkgIcon() {
//   return <Image style={styles.image} source={require('router/assets/pkg.png')} />
// }

// function ForwardIcon() {
//   return <Image style={styles.image} source={require('router/assets/forward.png')} />
// }
