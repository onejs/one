...
let Map: typeof import('../src/platform/ui/Map.ios').Map
let resolveNativeMapModel: typeof import('../src/platform/ui/mapValidation').resolveNativeMapModel

beforeAll(async () => {
  Map = (await import('../src/platform/ui/Map.ios')).Map
  resolveNativeMapModel = (await import('../src/platform/ui/mapValidation')).resolveNativeMapModel
})
