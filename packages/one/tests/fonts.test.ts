...
import type { FontMap, UseFontsResult } from '../src/platform/fonts/types'
...
async function loadEntry() {
  return import('../src/platform/fonts/index.native')
}
...
describe('web Fonts.isLoaded', () => {
  async function loadWebEntry() {
    return import('../src/platform/fonts/index')
  }
