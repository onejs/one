...
const sdkKinds = {
  ...
  appEntityUIElements: 'registeredValue',
  ...
  containerValue: 'registeredValue',
  ...
  mapFeatureSelectionContent: 'registeredValue',
  ...
  onApplePayCouponCodeChange: 'registeredValue',
  onApplePayPaymentMethodChange: 'registeredValue',
  onApplePayShippingContactChange: 'registeredValue',
  onApplePayShippingMethodChange: 'registeredValue',
  ...
  renameAction: 'event',
  reorderContainer: 'registeredValue',
  ...
  tracking: 'number',
  transaction: 'record',
  transactionTask: 'registeredValue',
