...
#import "OneNativeCircleComponentView.h"
#import <React/RCTView.h>
#import "VxrnNative-Swift.h"
#import "OneNativeCircleShadowNode.h"
#import "OneNativeMeasuredHeight.h"
#import <react/renderer/components/OneNativeSpec/EventEmitters.h>
#import <React/RCTConversions.h>
using namespace facebook::react;
@implementation OneNativeCircleComponentView { OneNativeCircleView *_nativeView; OneNativeMeasuredHeight *_measured; }
+ (ComponentDescriptorProvider)componentDescriptorProvider { return concreteComponentDescriptorProvider<OneNativeCircleComponentDescriptor>(); }
...
- (instancetype)initWithFrame:(CGRect)frame {
  if (self = [super initWithFrame:frame]) {
    _props = std::make_shared<const OneNativeCircleProps>();
    _measured = [OneNativeMeasuredHeight new];
    _nativeView = [OneNativeCircleView new]; self.contentView = _nativeView;
    __weak OneNativeCircleComponentView *weakSelf = self;
    _nativeView.onHeight = ^(CGFloat height) {
      OneNativeCircleComponentView *strongSelf = weakSelf;
...
- (void)updateProps:(Props::Shared const &)props oldProps:(Props::Shared const &)oldProps {
  const auto &next = *std::static_pointer_cast<const OneNativeCircleProps>(props);
