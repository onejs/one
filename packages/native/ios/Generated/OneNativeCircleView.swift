...
@objcMembers public final class OneNativeCircleView: UIView, OneNativeComposable {
  ...
  private var controller: OneNativeHostingController<OneNativeStandalone<CircleContent>>?
  ...
  private func updateHost() {
    ...
    if controller == nil {
      bindCallbacks()
      controller = OneNativeHostingController(rootView: OneNativeStandalone(content: CircleContent(model: model)))
    }
