...
- (void)updateProps:(Props::Shared const &)props oldProps:(Props::Shared const &)oldProps {
  ...
  [_nativeView configure:RCTNSStringFromString(next.label)
    disabled:next.disabled subtitle:RCTNSStringFromString(next.subtitle) systemImage:RCTNSStringFromString(next.systemImage) buttonRole:RCTNSStringFromString(next.buttonRole) buttonStyle:RCTNSStringFromString(next.buttonStyle) disclosureIndicator:next.disclosureIndicator controlSize:RCTNSStringFromString(next.controlSize)];
