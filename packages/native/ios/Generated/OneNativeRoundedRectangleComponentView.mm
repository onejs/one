...
#import "OneNativeRoundedRectangleComponentView.h"
#import <React/RCTView.h>
#import "VxrnNative-Swift.h"
#import "OneNativeRoundedRectangleShadowNode.h"
#import "OneNativeMeasuredHeight.h"
#import <react/renderer/components/OneNativeSpec/EventEmitters.h>
#import <React/RCTConversions.h>
using namespace facebook::react;
@implementation OneNativeRoundedRectangleComponentView { OneNativeRoundedRectangleView *_nativeView; OneNativeMeasuredHeight *_measured; }
+ (ComponentDescriptorProvider)componentDescriptorProvider { return concreteComponentDescriptorProvider<OneNativeRoundedRectangleComponentDescriptor>(); }
...
- (void)updateProps:(Props::Shared const &)props oldProps:(Props::Shared const &)oldProps {
  const auto &next = *std::static_pointer_cast<const OneNativeRoundedRectangleProps>(props);
  ...
  [_nativeView configure:(next.fill ? RCTUIColorFromSharedColor(next.fill) : nil)
    stroke:(next.stroke ? RCTUIColorFromSharedColor(next.stroke) : nil) lineWidth:next.lineWidth cornerRadius:next.cornerRadius];
