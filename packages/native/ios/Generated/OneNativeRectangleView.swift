...
@objcMembers public final class OneNativeRectangleView: UIView, OneNativeComposable {
  ...
  private var controller: OneNativeHostingController<OneNativeMeasuredStandalone<RectangleContent>>?
  ...
  private func updateHost() {
    ...
    if controller == nil {
      bindCallbacks()
      controller = OneNativeHostingController(rootView: OneNativeMeasuredStandalone(content: RectangleContent(model: model), onHeight: { [weak self] height in self?.onHeight?(height) }))
    }
