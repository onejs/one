...
#import "OneNativeEllipseComponentView.h"
#import <React/RCTView.h>
#import "VxrnNative-Swift.h"
#import "OneNativeEllipseShadowNode.h"
#import "OneNativeMeasuredHeight.h"
#import <react/renderer/components/OneNativeSpec/EventEmitters.h>
#import <React/RCTConversions.h>
using namespace facebook::react;
@implementation OneNativeEllipseComponentView { OneNativeEllipseView *_nativeView; OneNativeMeasuredHeight *_measured; }
+ (ComponentDescriptorProvider)componentDescriptorProvider { return concreteComponentDescriptorProvider<OneNativeEllipseComponentDescriptor>(); }
...
- (instancetype)initWithFrame:(CGRect)frame {
  if (self = [super initWithFrame:frame]) {
    _props = std::make_shared<const OneNativeEllipseProps>();
    _measured = [OneNativeMeasuredHeight new];
    _nativeView = [OneNativeEllipseView new]; self.contentView = _nativeView;
    __weak OneNativeEllipseComponentView *weakSelf = self;
    _nativeView.onHeight = ^(CGFloat height) {
      OneNativeEllipseComponentView *strongSelf = weakSelf;
...
- (void)updateProps:(Props::Shared const &)props oldProps:(Props::Shared const &)oldProps {
  const auto &next = *std::static_pointer_cast<const OneNativeEllipseProps>(props);
