...
#import "OneNativeCapsuleComponentView.h"
#import <React/RCTView.h>
#import "VxrnNative-Swift.h"
#import "OneNativeCapsuleShadowNode.h"
#import "OneNativeMeasuredHeight.h"
#import <react/renderer/components/OneNativeSpec/EventEmitters.h>
#import <React/RCTConversions.h>
using namespace facebook::react;
@implementation OneNativeCapsuleComponentView { OneNativeCapsuleView *_nativeView; OneNativeMeasuredHeight *_measured; }
+ (ComponentDescriptorProvider)componentDescriptorProvider { return concreteComponentDescriptorProvider<OneNativeCapsuleComponentDescriptor>(); }
...
- (instancetype)initWithFrame:(CGRect)frame {
  if (self = [super initWithFrame:frame]) {
    _props = std::make_shared<const OneNativeCapsuleProps>();
    _measured = [OneNativeMeasuredHeight new];
    _nativeView = [OneNativeCapsuleView new]; self.contentView = _nativeView;
    __weak OneNativeCapsuleComponentView *weakSelf = self;
    _nativeView.onHeight = ^(CGFloat height) {
      OneNativeCapsuleComponentView *strongSelf = weakSelf;
...
- (void)updateProps:(Props::Shared const &)props oldProps:(Props::Shared const &)oldProps {
  const auto &next = *std::static_pointer_cast<const OneNativeCapsuleProps>(props);
