...
- (void)updateProps:(Props::Shared const &)props oldProps:(Props::Shared const &)oldProps {
  ...
  [_nativeView configure:RCTNSStringFromString(next.label)
    disabled:next.disabled value:next.value total:next.total indeterminate:next.indeterminate progressViewStyle:RCTNSStringFromString(next.progressViewStyle) controlSize:RCTNSStringFromString(next.controlSize)];
