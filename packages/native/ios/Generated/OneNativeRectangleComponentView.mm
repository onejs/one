...
#import "OneNativeRectangleShadowNode.h"
#import "OneNativeMeasuredHeight.h"
#import <react/renderer/components/OneNativeSpec/EventEmitters.h>
#import <React/RCTConversions.h>
using namespace facebook::react;
@implementation OneNativeRectangleComponentView { OneNativeRectangleView *_nativeView; OneNativeMeasuredHeight *_measured; }
...
- (void)updateProps:(Props::Shared const &)props oldProps:(Props::Shared const &)oldProps {
  ...
  [_nativeView configure:(next.fill ? RCTUIColorFromSharedColor(next.fill) : nil)
    stroke:(next.stroke ? RCTUIColorFromSharedColor(next.stroke) : nil) lineWidth:next.lineWidth];
