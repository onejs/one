...
interface NativeProps extends ViewProps {
    ...
    onNativeFileImporterValueChange?: DirectEventHandler<Readonly<{
        value: boolean;
        eventCount: Int32;
        revision: Int32;
    }>>;
    onNativeFileImporterCompletion?: DirectEventHandler<Readonly<{
        type: string;
        url: string;
        index: Double;
        count: Double;
...
//# sourceMappingURL=OneNativeFileImporterNativeComponent.d.ts.map