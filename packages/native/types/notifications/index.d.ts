...
export declare function cancelScheduledNotificationAsync(_identifier: string): Promise<void>;
...
export declare function dismissNotificationAsync(_identifier: string): Promise<void>;
