...
export declare function Host({ axis, spacing, alignment, colorScheme, dynamicTypeSize, locale, tint, isEnabled, children, style, ...props }: HostProps): import("react/jsx-runtime").JSX.Element;
