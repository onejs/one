...
Read first: plans/handoff-one-native-parity.md in full, it is the contract for this package, and plans/one-native-swiftui-gap.md for the evidence behind the ranking. packages/one/README.md documents the public shape.
...
How this package works: codegen/Extract.swift parses .swiftinterface files, inventory.ts builds the symbol map, generate.ts drives the emitters, and generated output lands in packages/one/ios/Generated/ and src/generated/. Never hand-edit generated files. Change the mapping and regenerate.
