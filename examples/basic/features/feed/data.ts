...
Microsoft will answer with a better integration of copilot and everyone will be back to vscode...`,
  ...
  {
    id: 5,
    content: `Just finished a 48-hour coding marathon. Sleep is for the weak! #CodeLife`,
    user: {
      name: `CodeWarrior`,
      avatar: `https://placecats.com/millie/300/200`,
    },
  ...
  {
    id: 6,
    content: `If you're not coding in Rust, you're living in the past. #RustLang`,
    user: {
      name: `RustEvangelist`,
      avatar: `https://placecats.com/neo/300/200`,
    },
  ...
  {
    id: 7,
    content: `10x engineers don't need coffee. They run on pure adrenaline and passion. #10xEngineer`,
    user: {
      name: `AdrenalineCoder`,
      avatar: `https://placecats.com/neo/300/200`,
    },
  },
  {
    id: 8,
    content: `If you haven't rewritten your app in the latest JavaScript framework, are you even a developer? #FrameworkFrenzy`,
    user: {
      name: `JSFrameworkFanatic`,
      avatar: `https://placecats.com/neo_banana/300/200`,
    },
  },
  {
    id: 9,
    content: `Debugging is like being a detective in a crime movie where you are also the murderer. #DebuggingLife`,
    user: {
      name: `DebuggingDetective`,
      avatar: `https://placecats.com/millie_neo/300/200`,
    },
  },
  {
    id: 10,
    content: `Real developers use Vim. Everything else is just a toy. #VimLife`,
    user: {
      name: `VimGuru`,
      avatar: `https://placecats.com/neo/300/200`,
    },
  ...
  {
    id: 11,
    content: `If you can't explain your code to a rubber duck, you don't understand it well enough. #RubberDuckDebugging`,
    user: {
      name: `DuckDebugger`,
      avatar: `https://placecats.com/millie/300/200`,
    },
  ...
  {
    id: 12,
    content: `The only constant in programming is change. Embrace it or get left behind. #CodeWisdom`,
    user: {
      name: `ChangeChampion`,
      avatar: `https://placecats.com/neo_banana/300/200`,
    },
