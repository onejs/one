...
Yes. With [Metro mode](/docs/metro-mode) (recommended), you get full compatibility with the React Native ecosystem. For libraries that have issues with Vite, One provides a [`patches` system](/docs/configuration#patches) to fix common problems like Flow types or JSX in `.js` files.
