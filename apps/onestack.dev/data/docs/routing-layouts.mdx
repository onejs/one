...
### Root Layout Render Mode

You can configure the root layout to render on the server even for SPA pages, giving users immediate navigation chrome, head tags, and CSS. See [`web.renderRootLayout`](/docs/configuration#webrenderrootlayout) for details.
