...
|---------|-----|---------|-----|
| Color API | UIKit semantic colors | not exposed until native responsive roles land | returns null |
...
| Icons | SF Symbols via systemImage/systemName | Material Symbols via One.Android.Icon | unsupported |
