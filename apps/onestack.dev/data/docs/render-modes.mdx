...
It's downsides include a slower initial load time, and worse SEO. You can mitigate this with the [`renderRootLayout`](/docs/configuration#webrenderrootlayout) option, which renders your root layout on the server while keeping page content client-rendered.
