...
- [useMatches](/docs/hooks-useMatches) - Access loader data from any matched route
- [Loaders](/docs/routing-loader) - Defining route loaders
- [Layout Loaders](/docs/routing-layouts#layout-loaders) - Adding loaders to layouts
