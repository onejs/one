...
- **[Source Inspector](/docs/configuration#devtools)** - Hold Shift+Cmd (Mac) or Shift+Ctrl (Windows/Linux) and hover over any element to see its source file location. Click to open in your editor.
