...
Enables [React Scan](https://react-scan.com). Helps you re-rendering and other performance issues. You can enable it for only web or native, and also pass in options per-plaform from here.
