...
This inlines ALL CSS. For per-file control, use the [`?critical` import suffix](/docs/guides-css#critical-css-critical) instead, which only inlines the files you mark.
