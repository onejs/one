...
In building out this beautiful website, and the equally beautiful [tamagui.dev](https://tamagui.dev), one of the trickier
parts was getting MDX to work well.
...
The `@vxrn/mdx` package bundles together [Rehype](https://github.com/rehypejs/rehype) plugins alongside [mdx-bundler](https://github.com/kentcdodds/mdx-bundler) to provide a batteries-included MDX experience with:
