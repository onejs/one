...
Encodes the actual route as a base64 postfix in the URL (e.g., `/photos/5__L3Bob3Rvcy81L21vZGFs`). The server decodes the postfix and renders the correct route immediately — no flash.
